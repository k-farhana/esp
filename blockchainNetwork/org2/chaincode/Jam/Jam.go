...
func (cc *JamChaincode) create(stub shim.ChaincodeStubInterface, arg []string) peer.Response {

	args := strings.Split(arg[0], "^^")

	if len(args) != 7 {
		return shim.Error("Incorrect number arguments. Expecting 7")
	}
...
func (cc *JamChaincode) get(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *JamChaincode) update(stub shim.ChaincodeStubInterface, arg []string) peer.Response {
...
func (cc *JamChaincode) delete(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *JamChaincode) history(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *JamChaincode) querystring(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *JamChaincode) Init(stub shim.ChaincodeStubInterface) peer.Response {
	return shim.Success(nil)
}

func (cc *JamChaincode) Invoke(stub shim.ChaincodeStubInterface) peer.Response {
...
func main() {
	...
	err := shim.Start(new(JamChaincode))
	if err != nil {
